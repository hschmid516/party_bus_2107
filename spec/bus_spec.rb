...
describe Bus do
  ...
  context 'Capacity' do
    it 'returns the number of passengers' do
      ...
      expect(bus.number_of_passengers).to eq(bus.passengers.length)
    end

    it 'checks if bus is over capacity' do
      bus = Bus.new('Mikes Awesome Bus', 4)
      bus.add_passenger('Mike')
      bus.add_passenger('Megan')
      bus.add_passenger('Tim')
  ...
  context 'Kick out' do
    ...
    it 'kicks out the oldest passenger' do
      bus = Bus.new('Mikes Awesome Bus', 4)
      bus.add_passenger('Mike')
      bus.add_passenger('Megan')
      bus.add_passenger('Tim')
